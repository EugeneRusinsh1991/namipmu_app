...
## Информация о бекапе
- **Дата создания:** 2026-05-27_17-55-52
- **Оригинальная папка:** na_mi_pmu
- **Скопировано:** src, assets, scripts, package.json, package-lock.json, app.json, tsconfig.json, expo-env.d.ts, .gitignore, .vscode
...
1. **Скопируйте содержимое этой папки** в новую папку `na_mi_pmu`:
   ```bash
   xcopy na_mi_pmu_2026-05-27_17-55-52\* na_mi_pmu\ /E /I
   ```
...
1. **Скопируйте только изменённые файлы:**
   ```bash
   xcopy na_mi_pmu_2026-05-27_17-55-52\src na_mi_pmu\src /E /Y
   xcopy na_mi_pmu_2026-05-27_17-55-52\assets na_mi_pmu\assets /E /Y
   xcopy na_mi_pmu_2026-05-27_17-55-52\scripts na_mi_pmu\scripts /E /Y
   ```
...
1. **Копирование:**
   ```bash
   cp -r na_mi_pmu_2026-05-27_17-55-52/* na_mi_pmu/
   ```
...
---
**Последний бекап:** 2026-05-27_17-55-52
